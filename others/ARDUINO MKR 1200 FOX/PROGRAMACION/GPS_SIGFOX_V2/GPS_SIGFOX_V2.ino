...
String GetGPSpositon() {
  ...
  Wait(1, false);
  while (messages_count < 100) {/////////////////////////////////// bajo tiempo para saber si es ese el error, estaba a 5000, lo bajo a 1000
...
void loop() {
  ...
  String position_data; //ok

  position_data = GetGPSpositon();//ok
